...
// node_modules/.pnpm/@remotion+player@4.0.221_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@remotion/player/dist/esm/index.mjs
...
var usePlayer = () => {
  ...
  const [hasPlayed, setHasPlayed] = (0, import_react7.useState)(false);
  const frame = Internals.Timeline.useTimelinePosition();
  const playStart = (0, import_react7.useRef)(frame);
  const setFrame = Internals.Timeline.useTimelineSetFrame();
  const setTimelinePosition = Internals.Timeline.useTimelineSetFrame();
  const audioContext = (0, import_react7.useContext)(Internals.SharedAudioContext);
  const { audioAndVideoTags } = (0, import_react7.useContext)(Internals.Timeline.TimelineContext);
  const frameRef = (0, import_react7.useRef)(frame);
  frameRef.current = frame;
  const video = Internals.useVideo();
  const config = Internals.useUnsafeVideoConfig();
  const emitter = (0, import_react7.useContext)(PlayerEventEmitterContext);
  ...
  const bufferingContext = (0, import_react7.useContext)(Internals.BufferingContextReact);
  if (!bufferingContext) {
    throw new Error("Missing the buffering context. Most likely you have a Remotion version mismatch.");
  }
  const { buffering } = bufferingContext;
  const seek = (0, import_react7.useCallback)((newFrame) => {
  ...
  const play = (0, import_react7.useCallback)((e) => {
  ...
  const pauseAndReturnToPlayStart = (0, import_react7.useCallback)(() => {
    if (imperativePlaying.current) {
      imperativePlaying.current = false;
  ...
  const frameBack = (0, import_react7.useCallback)((frames) => {
    if (!videoId) {
      return null;
    }
    if (imperativePlaying.current) {
  ...
  const frameForward = (0, import_react7.useCallback)((frames) => {
    if (!videoId) {
      return null;
    }
    if (imperativePlaying.current) {
  ...
  const returnValue = (0, import_react7.useMemo)(() => {
    return {
      frameBack,
      frameForward,
      isLastFrame,
...
var useIsBackgrounded = () => {
  const isBackgrounded = (0, import_react8.useRef)(getIsBackgrounded());
...
var usePlayback = ({
  ...
  const setFrame = Internals.Timeline.useTimelineSetFrame();
  const buffering = (0, import_react5.useRef)(null);
  const isBackgroundedRef = useIsBackgrounded();
  const lastTimeUpdateEvent = (0, import_react5.useRef)(null);
  const context = (0, import_react5.useContext)(Internals.BufferingContextReact);
  if (!context) {
    throw new Error("Missing the buffering context. Most likely you have a Remotion version mismatch.");
  }
...
var useElementSize = (ref, options) => {
  ...
  const observer = (0, import_react9.useMemo)(() => {
  ...
  const updateSize = (0, import_react9.useCallback)(() => {
    if (!ref.current) {
      return;
    }
    const rect = ref.current.getClientRects();
...
var DefaultVolumeSlider = ({
  ...
  const sliderContainer = (0, import_react14.useMemo)(() => {
    const paddingLeft = 5;
    const common = {
      paddingLeft,
      height: ICON_SIZE,
  ...
  const randomId = typeof import_react14.default.useId === "undefined" ? "volume-slider" : import_react14.default.useId();
  const [randomClass] = (0, import_react14.useState)(() => `__remotion-volume-slider-${random(randomId)}`.replace(".", ""));
  const onVolumeChange = (0, import_react14.useCallback)((e) => {
    setVolume(parseFloat(e.target.value));
  }, [setVolume]);
  const inputStyle = (0, import_react14.useMemo)(() => {
    const commonStyle = {
...
var MediaVolumeSlider = ({ displayVerticalVolumeSlider, renderMuteButton, renderVolumeSlider }) => {
  ...
  const parentDivRef = (0, import_react13.useRef)(null);
  ...
  const parentDivStyle = (0, import_react13.useMemo)(() => {
    return {
      display: "inline-flex",
      background: "none",
      border: "none",
  ...
  const volumeContainer = (0, import_react13.useMemo)(() => {
    return {
      display: "inline",
      width: ICON_SIZE,
      height: ICON_SIZE,
  ...
  const renderDefaultMuteButton = (0, import_react13.useCallback)(({ muted, volume }) => {
  ...
  const muteButton = (0, import_react13.useMemo)(() => {
  ...
  const volumeSlider = (0, import_react13.useMemo)(() => {
...
function useComponentVisible(initialIsVisible) {
  const [isComponentVisible, setIsComponentVisible] = (0, import_react16.useState)(initialIsVisible);
...
var PlaybackrateOption = ({ rate, onSelect, selectedRate, keyboardSelectedRate }) => {
  ...
  const actualStyle = (0, import_react15.useMemo)(() => {
    return {
      ...rateDiv,
...
var PlaybackPopup = ({ setIsComponentVisible, playbackRates, canvasSize }) => {
  const { setPlaybackRate, playbackRate } = (0, import_react15.useContext)(Internals.Timeline.TimelineContext);
  const [keyboardSelectedRate, setKeyboardSelectedRate] = (0, import_react15.useState)(playbackRate);
  ...
  const onSelect = (0, import_react15.useCallback)((rate) => {
    setPlaybackRate(rate);
    setIsComponentVisible(false);
  }, [setIsComponentVisible, setPlaybackRate]);
  const playbackPopup = (0, import_react15.useMemo)(() => {
    return {
      position: "absolute",
      right: 0,
      width: 125,
...
var PlaybackrateControl = ({ playbackRates, canvasSize }) => {
  ...
  const { playbackRate } = (0, import_react15.useContext)(Internals.Timeline.TimelineContext);
  const onClick = (0, import_react15.useCallback)((e) => {
    e.stopPropagation();
    e.preventDefault();
...
var PlayerSeekBar = ({ durationInFrames, onSeekEnd, onSeekStart, inFrame, outFrame }) => {
  ...
  const frame = Internals.Timeline.useTimelinePosition();
  const [dragging, setDragging] = (0, import_react17.useState)({
    dragging: false
  });
  ...
  const onPointerUp = (0, import_react17.useCallback)(() => {
    setDragging({
      dragging: false
    });
    if (!dragging.dragging) {
  ...
  const knobStyle = (0, import_react17.useMemo)(() => {
    return {
      height: KNOB_SIZE2,
      width: KNOB_SIZE2,
  ...
  const fillStyle = (0, import_react17.useMemo)(() => {
    return {
      height: BAR_HEIGHT2,
...
var useVideoControlsResize = ({
  ...
  const resizeInfo = (0, import_react18.useMemo)(() => {
...
var Controls = ({
  ...
  const playButtonRef = (0, import_react12.useRef)(null);
  const frame = Internals.Timeline.useTimelinePosition();
  const [supportsFullscreen, setSupportsFullscreen] = (0, import_react12.useState)(false);
  const hovered = useHoverState(containerRef, hideControlsWhenPointerDoesntMove);
  const { maxTimeLabelWidth, displayVerticalVolumeSlider } = useVideoControlsResize({
    allowFullscreen,
    playerWidth: (canvasSize == null ? void 0 : canvasSize.width) ?? 0
  });
  const [shouldShowInitially, setInitiallyShowControls] = (0, import_react12.useState)(() => {
  ...
  const containerCss = (0, import_react12.useMemo)(() => {
  ...
  const timeLabel = (0, import_react12.useMemo)(() => {
    return {
      color: "white",
  ...
  const playbackRates = (0, import_react12.useMemo)(() => {
  ...
  const flexRef = (0, import_react12.useRef)(null);
  const onPointerDownIfContainer = (0, import_react12.useCallback)((e) => {
    if (e.target === ref.current || e.target === flexRef.current) {
      onPointerDown == null ? void 0 : onPointerDown(e);
    }
  }, [onPointerDown]);
  const onDoubleClickIfContainer = (0, import_react12.useCallback)((e) => {
    if (e.target === ref.current || e.target === flexRef.current) {
    ...
    children: [
      (0, import_jsx_runtime9.jsxs)("div", {
        ...
        children: [
          (0, import_jsx_runtime9.jsxs)("div", {
            ...
            children: [
              (0, import_jsx_runtime9.jsx)("button", {
                ...
                children: renderPlayPauseButton === null ? (0, import_jsx_runtime9.jsx)(DefaultPlayPauseButton, {
                  buffering,
                  playing: player.playing
                }) : renderPlayPauseButton({
                  playing: player.playing,
                  isBuffering: buffering
                }) ?? (0, import_jsx_runtime9.jsx)(DefaultPlayPauseButton, {
                  buffering,
                  playing: player.playing
                })
              }),
              showVolumeControls ? (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, {
                children: [
                  (0, import_jsx_runtime9.jsx)("div", {
                    style: xSpacer
                  }),
                  (0, import_jsx_runtime9.jsx)(MediaVolumeSlider, {
                    renderMuteButton,
                    renderVolumeSlider,
                    displayVerticalVolumeSlider
                  })
          ...
          playbackRates && canvasSize && (0, import_jsx_runtime9.jsx)(PlaybackrateControl, {
            canvasSize,
            playbackRates
          }),
          playbackRates && supportsFullscreen && allowFullscreen ? (0, import_jsx_runtime9.jsx)("div", {
            style: xSpacer
          }) : null,
          (0, import_jsx_runtime9.jsx)("div", {
            style: fullscreen,
            children: supportsFullscreen && allowFullscreen ? (0, import_jsx_runtime9.jsx)("button", {
              type: "button",
              "aria-label": isFullscreen ? "Exit fullscreen" : "Enter Fullscreen",
              title: isFullscreen ? "Exit fullscreen" : "Enter Fullscreen",
              style: playerButtonStyle,
              onClick: isFullscreen ? onExitFullscreenButtonClick : onFullscreenButtonClick,
              children: renderFullscreenButton === null ? (0, import_jsx_runtime9.jsx)(FullscreenIcon, {
                isFullscreen
      ...
      (0, import_jsx_runtime9.jsx)(PlayerSeekBar, {
        onSeekEnd,
        onSeekStart,
        durationInFrames,
        inFrame,
...
var useCancellablePromises = () => {
  const pendingPromises = (0, import_react21.useRef)([]);
  const appendPendingPromise = (0, import_react21.useCallback)((promise) => {
    pendingPromises.current = [...pendingPromises.current, promise];
  }, []);
  const removePendingPromise = (0, import_react21.useCallback)((promise) => {
    pendingPromises.current = pendingPromises.current.filter((p) => p !== promise);
  }, []);
  const clearPendingPromises = (0, import_react21.useCallback)(() => pendingPromises.current.map((p) => p.cancel()), []);
  const api = (0, import_react21.useMemo)(() => ({
...
var useClickPreventionOnDoubleClick = (onClick, onDoubleClick, doubleClickToFullscreen) => {
  ...
  const handleClick = (0, import_react20.useCallback)(async (e) => {
  ...
  const handleDoubleClick = (0, import_react20.useCallback)(() => {
    api.clearPendingPromises();
    onDoubleClick();
  }, [api, onDoubleClick]);
  const returnValue = (0, import_react20.useMemo)(() => {
...
var reactVersion = import_react11.default.version.split(".")[0];
if (reactVersion === "0") {
...
var PlayerUI = ({
  ...
  const [hasPausedToResume, setHasPausedToResume] = (0, import_react11.useState)(false);
  const [shouldAutoplay, setShouldAutoPlay] = (0, import_react11.useState)(autoPlay);
  const [isFullscreen, setIsFullscreen] = (0, import_react11.useState)(() => false);
  const [seeking, setSeeking] = (0, import_react11.useState)(false);
  const supportsFullScreen = (0, import_react11.useMemo)(() => {
    if (typeof document === "undefined") {
      return false;
    }
  ...
  const toggle = (0, import_react11.useCallback)((e) => {
    if (player.isPlaying()) {
      player.pause();
    } else {
      player.play(e);
  ...
  const requestFullscreen = (0, import_react11.useCallback)(() => {
    if (!allowFullscreen) {
  ...
  const exitFullscreen = (0, import_react11.useCallback)(() => {
  ...
  const initialScaleIgnored = (0, import_react11.useRef)(false);
  (0, import_react11.useEffect)(() => {
  ...
  const { setMediaVolume, setMediaMuted } = (0, import_react11.useContext)(Internals.SetMediaVolumeContext);
  const { mediaMuted, mediaVolume } = (0, import_react11.useContext)(Internals.MediaVolumeContext);
  (0, import_react11.useEffect)(() => {
  ...
  const [showBufferIndicator, setShowBufferState] = (0, import_react11.useState)(false);
  (0, import_react11.useEffect)(() => {
    let timeout = null;
    let stopped = false;
    const onBuffer = () => {
  ...
  const outerStyle = (0, import_react11.useMemo)(() => {
  ...
  const outer = (0, import_react11.useMemo)(() => {
    return calculateOuter({ config, layout, scale, overflowVisible });
  }, [config, layout, overflowVisible, scale]);
  const containerStyle3 = (0, import_react11.useMemo)(() => {
  ...
  const onError = (0, import_react11.useCallback)((error) => {
    player.pause();
    player.emitter.dispatchError(error);
  }, [player]);
  const onFullscreenButtonClick = (0, import_react11.useCallback)((e) => {
    e.stopPropagation();
    requestFullscreen();
  }, [requestFullscreen]);
  const onExitFullscreenButtonClick = (0, import_react11.useCallback)((e) => {
    e.stopPropagation();
    exitFullscreen();
  }, [exitFullscreen]);
  const onSingleClick = (0, import_react11.useCallback)((e) => {
  ...
  const onSeekStart = (0, import_react11.useCallback)(() => {
    setSeeking(true);
  }, []);
  const onSeekEnd = (0, import_react11.useCallback)(() => {
    setSeeking(false);
  }, []);
  const onDoubleClick = (0, import_react11.useCallback)(() => {
    if (isFullscreen) {
      exitFullscreen();
    } else {
      requestFullscreen();
  ...
  const loadingMarkup = (0, import_react11.useMemo)(() => {
  ...
  const currentScale = (0, import_react11.useMemo)(() => {
    return {
      type: "scale",
      scale
    };
  ...
  const content = (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, {
    children: [
      (0, import_jsx_runtime11.jsx)("div", {
        ...
        children: (0, import_jsx_runtime11.jsxs)("div", {
          ...
          children: [
            VideoComponent ? (0, import_jsx_runtime11.jsx)(ErrorBoundary, {
              onError,
              errorFallback,
              children: (0, import_jsx_runtime11.jsx)(Internals.ClipComposition, {
                children: (0, import_jsx_runtime11.jsx)(Internals.CurrentScaleContext.Provider, {
                  value: currentScale,
                  children: (0, import_jsx_runtime11.jsx)(VideoComponent, {
            ...
            shouldShowPoster && posterFillMode === "composition-size" ? (0, import_jsx_runtime11.jsx)("div", {
              style: {
                ...outerWithoutScale,
                width: config.width,
                height: config.height
      ...
      shouldShowPoster && posterFillMode === "player-size" ? (0, import_jsx_runtime11.jsx)("div", {
        style: outer,
        onPointerDown: clickToPlay ? handlePointerDown : void 0,
        onDoubleClick: doubleClickToFullscreen ? handleDoubleClick : void 0,
        children: poster
      }) : null,
      controls ? (0, import_jsx_runtime11.jsx)(Controls, {
        fps: config.fps,
  ...
  return (0, import_jsx_runtime11.jsx)("div", {
    ...
    style: outerStyle,
    className: className2,
    children: (0, import_jsx_runtime11.jsx)(import_react11.Suspense, {
      fallback: loadingMarkup,
      children: content
    })
  });
};
var PlayerUI_default = (0, import_react11.forwardRef)(PlayerUI);
...
var SharedPlayerContexts = ({
  ...
  const compositionManagerContext = (0, import_react22.useMemo)(() => {
    const context = {
      compositions: [
        {
          component,
  ...
  const [mediaMuted, setMediaMuted] = (0, import_react22.useState)(() => initiallyMuted);
  const [mediaVolume, setMediaVolume] = (0, import_react22.useState)(() => getPreferredVolume());
  const mediaVolumeContextValue = (0, import_react22.useMemo)(() => {
    return {
      mediaMuted,
      mediaVolume
    };
  }, [mediaMuted, mediaVolume]);
  const setMediaVolumeAndPersist = (0, import_react22.useCallback)((vol) => {
    setMediaVolume(vol);
    persistVolume(vol);
  }, []);
  const setMediaVolumeContextValue = (0, import_react22.useMemo)(() => {
    return {
      setMediaMuted,
      setMediaVolume: setMediaVolumeAndPersist
    };
  }, [setMediaVolumeAndPersist]);
  return (0, import_jsx_runtime12.jsx)(Internals.CanUseRemotionHooksProvider, {
    children: (0, import_jsx_runtime12.jsx)(Internals.Timeline.TimelineContext.Provider, {
      value: timelineContext,
      children: (0, import_jsx_runtime12.jsx)(Internals.CompositionManager.Provider, {
        value: compositionManagerContext,
        children: (0, import_jsx_runtime12.jsx)(Internals.ResolveCompositionConfig, {
          children: (0, import_jsx_runtime12.jsx)(Internals.PrefetchProvider, {
            children: (0, import_jsx_runtime12.jsx)(Internals.DurationsContextProvider, {
              children: (0, import_jsx_runtime12.jsx)(Internals.MediaVolumeContext.Provider, {
                value: mediaVolumeContextValue,
                children: (0, import_jsx_runtime12.jsx)(Internals.NativeLayersProvider, {
                  children: (0, import_jsx_runtime12.jsx)(Internals.SetMediaVolumeContext.Provider, {
                    value: setMediaVolumeContextValue,
                    children: (0, import_jsx_runtime12.jsx)(Internals.SharedAudioContextProvider, {
                      numberOfAudioTags: numberOfSharedAudioTags,
                      component,
                      children: (0, import_jsx_runtime12.jsx)(Internals.BufferingProvider, {
                        children
                      })
                    })
                  })
...
var PlayerFn = ({
  ...
  const [frame, setFrame] = (0, import_react10.useState)(() => ({
    [PLAYER_COMP_ID]: initialFrame ?? 0
  }));
  const [playing, setPlaying] = (0, import_react10.useState)(false);
  const [rootId] = (0, import_react10.useState)("player-comp");
  const rootRef = (0, import_react10.useRef)(null);
  const audioAndVideoTags = (0, import_react10.useRef)([]);
  const imperativePlaying = (0, import_react10.useRef)(false);
  const [currentPlaybackRate, setCurrentPlaybackRate] = (0, import_react10.useState)(playbackRate);
  ...
  (0, import_react10.useImperativeHandle)(ref, () => rootRef.current, []);
  const timelineContextValue = (0, import_react10.useMemo)(() => {
    return {
      frame,
      playing,
      rootId,
  ...
  const setTimelineContextValue = (0, import_react10.useMemo)(() => {
    return {
      setFrame,
      setPlaying
    };
  ...
  const actualInputProps = (0, import_react10.useMemo)(() => inputProps ?? {}, [inputProps]);
  const browserMediaControlsBehavior = (0, import_react10.useMemo)(() => {
    return passedBrowserMediaControlsBehavior ?? {
      mode: "prevent-media-session"
    };
  }, [passedBrowserMediaControlsBehavior]);
  return (0, import_jsx_runtime13.jsx)(Internals.IsPlayerContextProvider, {
    children: (0, import_jsx_runtime13.jsx)(SharedPlayerContexts, {
      ...
      numberOfSharedAudioTags,
      initiallyMuted,
      children: (0, import_jsx_runtime13.jsx)(Internals.Timeline.SetTimelineContext.Provider, {
        value: setTimelineContextValue,
        children: (0, import_jsx_runtime13.jsx)(PlayerEmitterProvider, {
          currentPlaybackRate,
          children: (0, import_jsx_runtime13.jsx)(PlayerUI_default, {
            ref: rootRef,
            posterFillMode,
            renderLoading,
...
var forward = import_react10.forwardRef;
var Player = forward(PlayerFn);
var useThumbnail = () => {
  const emitter = (0, import_react25.useContext)(ThumbnailEmitterContext);
  if (!emitter) {
    throw new TypeError("Expected Player event emitter context");
  }
  const returnValue = (0, import_react25.useMemo)(() => {
    return {
      emitter
    };
  }, [emitter]);
...
var reactVersion2 = import_react24.default.version.split(".")[0];
if (reactVersion2 === "0") {
...
var ThumbnailUI = ({ style, inputProps, errorFallback, renderLoading, className: className2, overflowVisible }, ref) => {
  const config = Internals.useUnsafeVideoConfig();
  const video = Internals.useVideo();
  const container = (0, import_react24.useRef)(null);
  const canvasSize = useElementSize(container, {
    triggerOnWindowResize: false,
    shouldApplyCssTransforms: false
  });
  const layout = (0, import_react24.useMemo)(() => {
    if (!config || !canvasSize) {
      return null;
    }
    return calculateCanvasTransformation({
  ...
  const VideoComponent = video ? video.component : null;
  const outerStyle = (0, import_react24.useMemo)(() => {
    return calculateOuterStyle({
      config,
      style,
      canvasSize,
  ...
  const outer = (0, import_react24.useMemo)(() => {
    return calculateOuter({ config, layout, scale, overflowVisible });
  }, [config, layout, overflowVisible, scale]);
  const containerStyle3 = (0, import_react24.useMemo)(() => {
    return calculateContainerStyle({
      canvasSize,
      config,
      layout,
  ...
  const onError = (0, import_react24.useCallback)((error) => {
    thumbnail.emitter.dispatchError(error);
  }, [thumbnail.emitter]);
  const loadingMarkup = (0, import_react24.useMemo)(() => {
    return renderLoading ? renderLoading({
      height: outerStyle.height,
      width: outerStyle.width,
      isBuffering: false
  ...
  const currentScaleContext = (0, import_react24.useMemo)(() => {
    return {
      type: "scale",
      scale
    };
  ...
  const content = (0, import_jsx_runtime14.jsx)("div", {
    style: outer,
    children: (0, import_jsx_runtime14.jsx)("div", {
      style: containerStyle3,
      className: PLAYER_CSS_CLASSNAME,
      children: VideoComponent ? (0, import_jsx_runtime14.jsx)(ErrorBoundary, {
        onError,
        errorFallback,
        children: (0, import_jsx_runtime14.jsx)(Internals.CurrentScaleContext.Provider, {
          value: currentScaleContext,
          children: (0, import_jsx_runtime14.jsx)(VideoComponent, {
            ...(video == null ? void 0 : video.props) ?? {},
            ...inputProps ?? {}
          })
        })
  ...
  return (0, import_jsx_runtime14.jsx)("div", {
    ...
    style: outerStyle,
    className: className2,
    children: (0, import_jsx_runtime14.jsx)(import_react24.Suspense, {
      fallback: loadingMarkup,
      children: content
    })
  });
};
var ThumbnailUI_default = (0, import_react24.forwardRef)(ThumbnailUI);
var ThumbnailFn = ({
  frameToDisplay,
  style,
  inputProps,
  ...
  const [thumbnailId] = (0, import_react23.useState)(() => String(random(null)));
  const rootRef = (0, import_react23.useRef)(null);
  const timelineState = (0, import_react23.useMemo)(() => {
    const value = {
      playing: false,
      frame: {
  ...
  (0, import_react23.useImperativeHandle)(ref, () => rootRef.current, []);
  const Component = Internals.useLazyComponent(componentProps);
  const [emitter] = (0, import_react23.useState)(() => new ThumbnailEmitter());
  const passedInputProps = (0, import_react23.useMemo)(() => {
    return inputProps ?? {};
  }, [inputProps]);
  return (0, import_jsx_runtime15.jsx)(Internals.IsPlayerContextProvider, {
    children: (0, import_jsx_runtime15.jsx)(SharedPlayerContexts, {
      ...
      initiallyMuted: true,
      children: (0, import_jsx_runtime15.jsx)(ThumbnailEmitterContext.Provider, {
        value: emitter,
        children: (0, import_jsx_runtime15.jsx)(ThumbnailUI_default, {
          ref: rootRef,
          className: className2,
          errorFallback,
...
var forward2 = import_react23.forwardRef;
