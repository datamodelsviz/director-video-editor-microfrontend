...
import { MoveableTargetInfo } from "./utils/get-moveable-target-info";
import { DragScrollOptions } from "../drag-scroll";
...
export type MoveableRefTargetsResultType = Array<HTMLElement | SVGElement | string | null | MoveableRefTargetsResultType>;
/**
 * @memberof Moveable
 * @typedef
 */
export type MoveableRefType<T extends Element = HTMLElement | SVGElement> = string | (() => T) | MoveableRefObject<T> | T | null | undefined;
/**
 * @memberof Moveable
 * @typedef
 */
...
export type RotationPosition = "top" | "bottom" | "left" | "right" | "top-right" | "top-left" | "bottom-right" | "bottom-left" | "left-top" | "left-bottom" | "right-top" | "right-bottom" | "none";
/**
 * @typedef
 * @memberof Moveable.Rotatable
 * @extends Moveable.RenderDirections
...
export type AnyProps<T extends IObject<any>> = Required<{
    [key in keyof T]: any;
}>;
...
export type ExcludeEndParams<T extends IObject<any>> = ExcludeKeys<ExcludeParams<T>, "lastEvent" | "isDrag" | "isDouble">;
