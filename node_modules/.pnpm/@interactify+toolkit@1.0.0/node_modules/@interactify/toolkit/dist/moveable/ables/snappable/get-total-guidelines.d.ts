...
export declare function getGridGuidelines(moveable: MoveableManagerInterface<SnappableProps, SnappableState>, containerWidth: number, containerHeight: number, clientLeft: number, clientTop: number, snapOffset: {
    left: number;
    top: number;
    right: number;
    bottom: number;
