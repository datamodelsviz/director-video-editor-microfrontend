...
declare const _default: {
    ...
    drag(moveable: MoveableManagerInterface<DraggableProps>, e: any): import("../types").OnDrag;
    dragEnd(moveable: MoveableManagerInterface<DraggableProps, any>, e: any): import("../types").OnDragEnd;
    dragGroupCondition(moveable: MoveableGroupInterface<DraggableProps>, e: any): boolean;
    dragGroupStart(moveable: MoveableGroupInterface<DraggableProps>, e: any): any;
    dragGroup(moveable: MoveableGroupInterface<DraggableProps>, e: any): import("../types").OnDragGroup;
