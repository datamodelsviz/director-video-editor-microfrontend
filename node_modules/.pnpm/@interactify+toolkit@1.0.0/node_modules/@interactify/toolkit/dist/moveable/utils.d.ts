...
export declare function getTotalDirection(parentDirection: number[], isPinch: boolean, inputEvent: any, datas: any): number[];
export declare function getDirection(target: SVGElement | HTMLElement, datas: any): number[];
